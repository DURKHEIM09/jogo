...
const EMPLOYEE_NAME := "Nina"
const EMPLOYEE_ROLE := "Atendente"
const EMPLOYEE_HIRING_COST := 35
const EMPLOYEE_WAGE := 18
const EMPLOYEE_WAGE_CYCLE := 24.0
const EMPLOYEE_WAGE_RETRY_DELAY := 5.0
const EMPLOYEE_PRODUCTIVITY := 1.45
const EMPLOYEE_RELIABILITY := 0.84
const EMPLOYEE_INITIAL_MORALE := 72.0
const EMPLOYEE_CUSTOMER_CAPACITY := 10
const EMPLOYEE_REPUTATION_SALE_GAIN := 0.67
const EMPLOYEE_PAY_MORALE_GAIN := 3.0
const EMPLOYEE_MISSED_PAYROLL_MORALE_PENALTY := 10.0
const EMPLOYEE_MISSED_PAYROLL_REPUTATION_PENALTY := 1.2
const EMPLOYEE_SERVICE_MORALE_GAIN := 0.08
const EMPLOYEE_SERVICE_FAIL_MORALE_PENALTY := 0.9
const EMPLOYEE_SERVICE_FAIL_WAIT_MULTIPLIER := 1.3
const EMPLOYEE_MORALE_FACTOR_MIN := 0.55
const EMPLOYEE_MORALE_FACTOR_MAX := 1.15
const EMPLOYEE_RELIABILITY_MIN := 0.45
const EMPLOYEE_RELIABILITY_MAX := 0.96
...
const COLOR_EMPLOYEE := Color(0.545, 0.847, 1.0, 1.0)
const COLOR_EMPLOYEE_OFF := Color(0.443, 0.502, 0.576, 1.0)
